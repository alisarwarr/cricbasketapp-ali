...
import { selectBasket, added, removed, quited, reset } from '../toolkit/basketSlice';
import { clickedItemID } from '../toolkit/itemIdSlice';
...
function Basket() {
    ...
    const [ clicked, setClicked ] = useState<boolean>(false);            //for again render to get updated data
